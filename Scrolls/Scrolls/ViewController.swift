...
class ViewController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        for i in 0...1 {
            ...
            for i in 0...1 {
                var y = CGFloat(568 * i)
                var blueBox = UIView(frame: CGRectMake(0, y, 320, 528))
                scrollView.addSubview(blueBox)
                blueBox.backgroundColor = UIColor(white: CGFloat(arc4random_uniform(100)) / 100, alpha: 1.0)
        ...
        //        for i in 0...9 {
        //            var x = CGFloat(160 * i)
        //            var blueBox = UIView(frame: CGRectMake(x, 0, 160, 528))
        //            scrollView.addSubview(blueBox)
        //            blueBox.backgroundColor = UIColor(white: CGFloat(arc4random_uniform(100)) / 100, alpha: 1.0)
        //            scrollView.addSubview(blueBox)
        //        }
