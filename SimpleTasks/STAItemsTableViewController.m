...
{
    STAEditItemViewController * addNewGroupVC = [[STAEditItemViewController alloc]init];
    
    addNewGroupVC.items = self.groupInfo[@"items"];
...
{
    EDITYOURITEMSViewController * editItemTVC = [[EDITYOURITEMSViewController alloc]init];
    
    
    
    editItemTVC.itemInfo = self.groupInfo[@"items"][indexPath.row];

    
    [self.navigationController pushViewController:editItemTVC animated:YES];
}
